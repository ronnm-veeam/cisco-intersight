...
[string]$Script:InstallLogDir = 'C:\users\Administrator\Downloads\VBRtmp' #No trailing slash required
[string]$Script:LicenseFile = 'C:\users\Administrator\Downloads\Veeam-100instances-suite-nfr.lic'
...
[string]$Script:All_Service_Username = 'Administrator'
[string]$Script:All_Service_Password = 'Wrhgrs0!'
