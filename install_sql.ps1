...
if ($sqltest.count -eq 0 ) {
    ...
    $arguments="/Q /IACCEPTSQLSERVERLICENSETERMS /SUPPRESSPRIVACYSTATEMENTNOTICE /IACCEPTROPENLICENSETERMS /Action=Install /Features=SQL,Tools /InstanceName=$sqlinstancename /SQLSYSADMINACCOUNTS=$srvdomuser /SQLSVCACCOUNT=$srvdomuser /SQLSVCPASSWORD=$srvpasswd"
